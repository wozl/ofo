...
<body style="background-image:url(<%=request.getContextPath() %>/images/3.png)">

	<form action="<%=request.getContextPath() %>/ofo/regs.do" method="post">
	<center>
    	<div style="width:260px;">
    	<h3 style="color:#CF6">欢迎注册ofo密码查询系统</h3>
        ...
        <div class="input-group" style="background-color:#FFF">
        	...
        	<button class="btn" type="reset">重置</button>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button class="btn btn-primary" type="submit" onclick="return chekAll()">注册</button>
    </center>
    </div>
	</form>
